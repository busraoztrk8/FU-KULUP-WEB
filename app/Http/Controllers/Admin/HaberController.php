            ...
            try {
                ...
                return \Yajra\DataTables\Facades\DataTables::of($data)
                    ...
                    ->addColumn('action', function($row) {
                        ...
                        $btn .= '<button onclick="showHaberDetay('.$row->id.')" class="action-btn text-slate-400 hover:text-primary transition-colors" title="Görüntüle"><span class="material-symbols-outlined text-[18px]">visibility</span></button>';
                        $btn .= '<button onclick="showHaberDuzenle('.$row->id.')" class="action-btn text-slate-400 hover:text-primary transition-colors" title="Düzenle"><span class="material-symbols-outlined text-[18px]">edit</span></button>';
