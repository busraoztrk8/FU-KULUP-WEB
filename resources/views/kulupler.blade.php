...
<div class="px-6 md:px-12 max-w-7xl mx-auto pb-12">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div data-category="startup"
            ...
            <div class="h-48 overflow-hidden relative">
                ...
                <div class="absolute top-4 left-4 bg-white/20 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold text-white uppercase tracking-widest">
                    Girişimcilik
                </div>
            </div>
            <div class="p-8 flex flex-col flex-1">
                <div class="flex justify-between items-start mb-4">
                    <h3 data-club-name class="text-2xl font-bold font-headline text-white group-hover:text-white/90 transition-colors">İnovasyon Liderleri</h3>
                    <div class="flex items-center text-white/70 text-xs font-bold">
                        <span class="material-symbols-outlined text-sm mr-1">group</span>
                        2.4K Üye
                    </div>
                </div>
                <p class="text-white/80 text-sm mb-8 leading-relaxed line-clamp-3">Yeni nesil startup ekosistemini tanıyor, yatırımcılarla buluşuyor ve fikirlerimizi hayata geçiriyoruz.</p>
        ...
        <div data-category="art"
            ...
            <div class="p-8 flex flex-col flex-1">
                <div class="flex justify-between items-start mb-4">
                    <h3 data-club-name class="text-2xl font-bold font-headline text-white group-hover:text-white/90 transition-colors">Modern Sanat Atölyesi</h3>
                    <div class="flex items-center text-white/70 text-xs font-bold">
                        <span class="material-symbols-outlined text-sm mr-1">group</span>
                        850 Üye
                    </div>
                </div>
                <p class="text-white/80 text-sm mb-8 leading-relaxed line-clamp-3">Dijital sanattan klasik tekniklere kadar geniş bir yelpazede yaratıcılığımızı serbest bırakıyoruz.</p>
        ...
        <div data-category="social"
            ...
            <div class="p-8 flex flex-col flex-1">
                <div class="flex justify-between items-start mb-4">
                    <h3 data-club-name class="text-2xl font-bold font-headline text-white group-hover:text-white/90 transition-colors">Gönüllü Kalpler</h3>
                    <div class="flex items-center text-white/70 text-xs font-bold">
                        <span class="material-symbols-outlined text-sm mr-1">group</span>
                        3.1K Üye
                    </div>
                </div>
                <p class="text-white/80 text-sm mb-8 leading-relaxed line-clamp-3">Toplumsal sorunlara çözüm üretiyor, sürdürülebilir bir gelecek için projeler geliştiriyoruz.</p>
        ...
        <div data-category="sport"
            ...
            <div class="p-8 flex flex-col flex-1">
                <div class="flex justify-between items-start mb-4">
                    <h3 data-club-name class="text-2xl font-bold font-headline text-white group-hover:text-white/90 transition-colors">E-Spor ve Gaming</h3>
                    <div class="flex items-center text-white/70 text-xs font-bold">
                        <span class="material-symbols-outlined text-sm mr-1">group</span>
                        4.2K Üye
                    </div>
                </div>
                <p class="text-white/80 text-sm mb-8 leading-relaxed line-clamp-3">Turnuvalar düzenliyor, strateji geliştiriyor ve rekabetçi oyun dünyasında zirveyi hedefliyoruz.</p>
        ...
        <div data-category="tech"
            ...
            <div class="p-8 flex flex-col flex-1">
                <div class="flex justify-between items-start mb-4">
                    <h3 data-club-name class="text-2xl font-bold font-headline text-white group-hover:text-white/90 transition-colors">Siber Güvenlik Ekibi</h3>
                    <div class="flex items-center text-white/70 text-xs font-bold">
                        <span class="material-symbols-outlined text-sm mr-1">group</span>
                        1.1K Üye
                    </div>
                </div>
                <p class="text-white/80 text-sm mb-8 leading-relaxed line-clamp-3">Dijital dünyayı güvenli hale getirmek için CTF yarışmalarına katılıyor ve etik hacking çalışmaları yapıyoruz.</p>
        ...
        <div data-category="social"
            ...
            <div class="p-8 flex flex-col flex-1">
                <div class="flex justify-between items-start mb-4">
                    <h3 data-club-name class="text-2xl font-bold font-headline text-white group-hover:text-white/90 transition-colors">Gezi ve Fotoğrafçılık</h3>
                    <div class="flex items-center text-white/70 text-xs font-bold">
                        <span class="material-symbols-outlined text-sm mr-1">group</span>
                        1.8K Üye
                    </div>
                </div>
                <p class="text-white/80 text-sm mb-8 leading-relaxed line-clamp-3">Yeni yerler keşfediyor, anları ölümsüzleştiriyor ve vizyonumuzu gezerek genişletiyoruz.</p>
    ...
    <div class="mt-16 flex justify-center items-center space-x-3">
        ...
        <button class="w-12 h-12 rounded-2xl flex items-center justify-center bg-primary text-white font-bold shadow-lg shadow-primary/30">1</button>
        <button
