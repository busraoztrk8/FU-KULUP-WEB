...
<a href="{{ $href }}" 
   class="flex items-center gap-3 px-4 py-2 mx-2 my-0.5 rounded-xl text-[14px] font-medium transition-all duration-200 {{ $activeClass }} whitespace-nowrap overflow-hidden">
